...
const Shipping = () => {
    return (
        <div className='my-12 px-5 md:px-40'>  
           <div className='flex flex-col gap-5 items-left text-left'>
                <h1 className='text-2xl md:text-4xl font-bold text-green-700 text-wrap flex gap-4 items-left'>
                Shipping and Delivery
                </h1>
                <p className='text-lg font-normal text-gray-700  text-wrap flex gap-5'>
                ...
                <h1 className='text-2xl md:text-2xl font-bold text-green-700 text-wrap flex gap-4 items-left'>
                Shipping Rates
                </h1>
                <ul className='text-lg font-normal text-gray-700 text-wrap gap-5 list-disc list-inside'>
                    <li>All & freshly frozen items ship FREE nationwide when you order $125+ of # freshly frozen items.
                    </li>
                    <li>
                    Orders containing less
                ...
                <p className='text-lg font-normal text-gray-700  text-wrap flex gap-5'>Orders placed by 10pm ET will ship the next business day and be delivered within 2 days of shipment. Specific delivery days can be
                requested.
                </p>
                <p className='text-lg font-normal text-gray-700  text-wrap flex gap-5'>Freshly frozen, live/fresh, and shelf stable items ship in separate boxes to ensure optimal quality.
                </p>
                <ul className='text-lg font-normal text-gray-700  text-wrap  gap-5 list-disc list-inside'>
                    <li>
                ...
                <p className='text-lg font-normal text-gray-700 text-wrap flex gap-5'>Our main activities are EXPORT OF FROZEN FISH & FISH PROCESSING
                FOR HORECA / FOOD SERVICE.
                </p>
                <p className='text-lg font-normal text-gray-700  text-wrap flex gap-5'>Our main offices are located in Bilbao & Vigo (Spain), we have local
                ...
                <p className='text-lg font-normal text-gray-700 text-wrap flex gap-5'>Our company culture strongly belleve in Kalzen methodology and
                putting in the first place a Corporate Social Responsibility and Service
                to the customer.
                </p>
                <p className='text-lg font-normal text-gray-700 text-wrap flex gap-5'>Driven by a motto "We Live to Give" our vision is to
